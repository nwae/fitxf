#!/usr/bin/env python
# -*- coding: utf-8 -*-
# https://github.com/coderByNeed/BOB404/blob/master/audio/compressions.py
...
def u_law_e(i16bit):
    ...
    for x in reversed(
            range(pos)):  # this number has least significant bits, not bit... so they have often size of 4 bits, that is why it must be larger than 5
